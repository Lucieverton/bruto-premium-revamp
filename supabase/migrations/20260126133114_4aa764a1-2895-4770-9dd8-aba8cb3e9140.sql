-- First drop the old function to allow changing return type
DROP FUNCTION IF EXISTS public.get_public_queue();

-- Recreate with enhanced return type including service and barber names
...
AS $function$
  SELECT 
    ...
    qi.service_id,
    qi.barber_id,
    -- Show first name + initial of last name for better identification
    CASE 
