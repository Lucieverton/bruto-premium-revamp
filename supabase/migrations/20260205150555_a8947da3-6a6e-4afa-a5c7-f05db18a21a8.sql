-- FASE 1: Remover função legada join_queue para evitar PGRST203
DROP FUNCTION IF EXISTS public.join_queue(text, text, uuid, uuid, text);

-- FASE 1: Atualizar add_walkin_client para suportar múltiplos serviços
...
-- FASE 1: Atualizar barber_add_client_direct para suportar múltiplos serviços
