...
export const Hero = () => {
  return (
    <header className="relative h-[calc(100vh-96px)] md:h-[calc(100vh-112px)] w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-5 max-w-4xl mx-auto">
        ...
        <p
          className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 animate-fadeInUp"
